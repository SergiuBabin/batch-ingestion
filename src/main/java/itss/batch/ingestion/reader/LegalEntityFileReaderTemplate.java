...
@Component
public class LegalEntityFileReaderTemplate extends FlatFileItemReader<LegalEntityCsvTemplate> implements ItemReader<LegalEntityCsvTemplate> {

    public LegalEntityFileReaderTemplate(@Value("${input.file1}") String inputFile) throws FileNotFoundException {
