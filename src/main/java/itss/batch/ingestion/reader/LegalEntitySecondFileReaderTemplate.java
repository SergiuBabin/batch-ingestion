...
@Component
public class LegalEntitySecondFileReaderTemplate extends FlatFileItemReader<LegalEntityCsvTemplate> implements ItemReader<LegalEntityCsvTemplate> {

    public LegalEntitySecondFileReaderTemplate(@Value("${input.file2}") String inputFile) throws FileNotFoundException {
